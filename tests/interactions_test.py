...
class TestInteractions:
    ...
    class TestSortable:
        ...
        def test_sortable_list_and_grid(self, driver):
            ...
            sortable_page.open()
            list_before, list_after = sortable_page.change_list_or_grid_order('sort_list')
            grid_before, grid_after = sortable_page.change_list_or_grid_order('sort_grid')
    ...
    class TestSelectable:
        ...
        def test_selectable(self, driver):
            ...
            item_list = selectable_page.select_list_or_grid_item('select_list')
            item_grid = selectable_page.select_list_or_grid_item('select_grid')
    ...
    class TestDraggablePage:
        ...
        def test_axis_restricted_draggable(self, driver):
            draggable_page = DraggablePage(driver, 'https://demoqa.com/dragabble')
            draggable_page.open()
            top_x, left_x = draggable_page.axis_restricted_x_or_y('x')
            top_y, left_y = draggable_page.axis_restricted_x_or_y('y')
