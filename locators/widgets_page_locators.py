...
class AutoCompletePageLocators:
    ...
    MULTIPLE_VALUE = (By.CSS_SELECTOR, 'div[class*="css-1rhbuit-multiValue"]')
    MULTIPLE_VALUE_REMOVE = (By.CSS_SELECTOR, 'div[class*="css-1rhbuit-multiValue"] svg path')
    MULTIPLE_VALUE_REMOVE_ALL = (By.CSS_SELECTOR, 'div[class="auto-complete__indicators css-1wy0on6"] svg path')
