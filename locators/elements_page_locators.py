...
class TextBoxPageLocators:
    ...
    MOVE_TO_SUBMIT_BUTTON = (By.CSS_SELECTOR, '.mt-2.justify-content-end')
...
class WebTablesPageLocators:
    ...
    GO_TO_SEARCH_INPUT = (By.CSS_SELECTOR, 'div[class="mt-2 justify-content-end row"]')
...
class ButtonsPageLocators:
    ...
    # CLICK_ME_BUTTON = (By.CSS_SELECTOR, 'div[class="mt-4"]:nth-child(4) button')
